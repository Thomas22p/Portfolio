...
<template>
  ...
  <section>
    <div>
      <div class="md:block hidden">
        <div class="md:grid md:grid-cols-12 md:justify-stretch md:gap-4 flex px-4 md:px-24 font-darker">
          ...
          <div class="text-white col-start-4 col-span-7">
            <h2 class="text-6xl font-medium mb-12">A site, an artistic movement</h2>
            <p class="text-2xl font-medium leading-none">The concept is simple, create a website based on an artistic movement. 
            Personally, I had the Primitivism movement, which favors naive forms.
            In designing and developing the site, I sought to capture the essence of this movement by prioritizing simple and expressive visual elements. The site's design reflects the simplicity and spontaneity characteristic of Primitivism, providing visitors with an immersion into this unique artistic universe.
            </p>
          </div>
        </div>
      </div>
      <div class="px-4 font-darker md:hidden block">
        ...
        <div class="text-white grid grid-cols-12 justify-stretch gap-4">
          <p class="text-grey col-start-1 col-span-2 font-medium text-2xl">Concept</p>
          <h2 class="text-4xl font-medium mb-12 col-start-4 col-span-8">A site, an artistic movement</h2>
        </div>
        <p class="text-2xl font-normal leading-none text-white">The concept is simple, create a website based on an artistic movement. 
            Personally, I had the Primitivism movement, which favors naive forms.
            In designing and developing the site, I sought to capture the essence of this movement by prioritizing simple and expressive visual elements. The site's design reflects the simplicity and spontaneity characteristic of Primitivism, providing visitors with an immersion into this unique artistic universe.
        </p>
      </div>
    ...
    <div>
      <div class="md:block hidden">
          <div class="md:grid md:grid-cols-12 md:justify-stretch md:gap-4 flex px-4 md:px-24 font-darker">
            ...
            <div class="text-white col-start-4 col-span-7">
              <h2 class="text-6xl font-medium mb-12">The simplicity of a brand identity</h2>
              <p class="text-2xl font-medium leading-none">This project emerged from a three-day exam, during which I navigated tight deadlines to design the logo. The constraints and the simplistic nature of the art movement prompted me to simplify the design approach.
             <br><br>
              However, this experience underscored that simplicity can yield an effective and memorable logo. Simple designs facilitate quick comprehension and readability in graphic design. Additionally, they offer versatility and adaptability across different contexts and media.
            </p>
            </div>
          </div>
        </div>
        <div class="px-4 font-darker md:hidden block">
          ...
          <div class="text-white grid grid-cols-12 justify-stretch gap-4">
            <p class="text-grey col-start-1 col-span-2 font-medium text-2xl">Branding</p>
            <h2 class="text-4xl font-medium mb-12 col-start-4 col-span-8">The simplicity of a brand identity</h2>
          </div>
          <p class="text-2xl font-normal leading-none text-white">This project emerged from a three-day exam, during which I navigated tight deadlines to design the logo. The constraints and the simplistic nature of the art movement prompted me to simplify the design approach.
            <br><br>
          However, this experience underscored that simplicity can yield an effective and memorable logo. Simple designs facilitate quick comprehension and readability in graphic design. Additionally, they offer versatility and adaptability across different contexts and media.
          </p>
        </div>
    ...
    <div>
        <div class="md:block hidden">
            <div class="md:grid md:grid-cols-12 md:justify-stretch md:gap-4 flex px-4 md:px-24 font-darker">
              <p class="text-grey col-start-1 col-span-2 font-medium text-2xl pt-4">The interface</p>
              <div class="text-white col-start-4 col-span-7">
                <h2 class="text-6xl font-medium mb-12">Designing with Intention: From wireframes to prototype</h2>
                <p class="text-2xl font-medium leading-none">The fundamental idea that motivated this design was to rely on the artistic movement promoting simple, raw shapes and friendly, natural colors.
                I took care of the entire design process, starting with the creation of wireframes to establish the basic structure, up to prototyping which is a more advanced step towards finalizing the design. All this while always taking care to respect this idea.
                </p>
              </div>
            </div>
          </div>
          <div class="px-4 font-darker md:hidden block">
            ...
            <div class="text-white grid grid-cols-12 justify-stretch gap-4">
              <p class="text-grey col-start-1 col-span-2 font-medium text-2xl">The interface</p>
              <h2 class="text-4xl font-medium mb-12 col-start-4 col-span-8">Designing with Intention: From wireframes to prototype</h2>
            </div>
            <p class="text-2xl font-normal leading-none text-white">The fundamental idea that motivated this design was to rely on the artistic movement promoting simple, raw shapes and friendly, natural colors.
            I took care of the entire design process, starting with the creation of wireframes to establish the basic structure, up to prototyping which is a more advanced step towards finalizing the design. All this while always taking care to respect this idea.
            </p>
          </div>
      </div>
            ...
            <div class="relative">
                ...
                <div class="">
                    ...
                    <div class="flex items-center gap-2 absolute bottom-5 left-5 flex-wrap">
                        ...
                        <div class="border-2 border-white rounded-full px-2.5 h-[26px]">
                            <p class="text-lg font-darker text-white font-medium  -mt-1">3D MAPPING</p>
                        </div>
                        <div>
                            <img src="../assets/icn-svg/2023-button.svg" alt="producted in 2023" class="h-[26px]">
                        </div>
                  ...
                  <div class="relative">
                      ...
                      <div class="">
                          ...
                          <div class="flex items-center gap-2 absolute bottom-5 px-2.5">
                              ...
                              <div class="border-2 border-white rounded-full px-2 pt-0.5 h-[26px]">
                                  <p class="text-md font-darker text-white font-medium  -mt-1">3D MAPPING</p>
                              </div>
                              <div>
                                  <img src="../assets/icn-svg/2023-button.svg" alt="producted in 2023" class="h-[26px]">
                              </div>
