...
<template>
  ...
  <section>
    ...
    <div class="relative">
      ...
      <img src="../assets/img/my-logo.png" alt="paysage" class="w-full rounded-t-[50px]">
    </div>
  ...
  <section class="px-4 md:px-24 -mt-28 mb-[200px]">
    ...
    <div class="flex w-full justify-between">
      ...
      <RouterLink to="/campus">
          <div class="relative">
              <img class="object-cover object-center w-[400px] h-[600px] rounded-2xl" src="../assets/img/mockup-campus.jpg" alt="Second project - Campus">
              <div class="">
